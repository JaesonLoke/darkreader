...
function create_ui_elements(contentDoc, supporting_links, thisURL) {
    ...
    viewnotes_button_div.textContent = "MUSIC PLAYER";
...
function showMenuDiv(cdoc) {
    ...
    if(a == 1){
        window.open("https://www.youtube.com/watch?v=CfPxlb8-ZQ0&t=110s","_blank");
    }
    else{
        window.open("https://www.youtube.com/watch?v=1oahTaVIQvk&t=86s","_blank");
    }
}
